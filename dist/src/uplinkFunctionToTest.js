...
exports.decodeUplink = void 0;
exports.hexToDecArr = hexToDecArr;
        ...
        const handleResponse = (bytes, data) => {
            ...
            commands.forEach((command, i) => {
                switch (command) {
                    ...
                    case 'a0': {
                        command_len = 4;
                        const fuota_address = parseInt(`${commands[i + 1]}${commands[i + 2]}${commands[i + 3]}${commands[i + 4]}`, 16);
...
const result = (0, exports.decodeUplink)(input);
const resultTwo = (0, exports.decodeUplink)(inputTwo);
